    ...
    <div class="l-inner">
      <div class="p-features__content">
        <div class="p-features__card">
          ...
          <p class="p-features__card-text">石州瓦の原料は耐火度が非常に高く、アルカリ分が少ないカオリサイトやハロイサイトなどの高耐火度の粘土鉱物の割合が多いため、<span>１２００℃以上の高温焼成</span>にも耐えられます。</p>
        </div>
        <div class="p-features__card">
          <div class="p-features__card-detail">
            <div class="p-features__block">
              <p class="p-features__card-label">高密度な構造</p>
              <h3 class="p-features__card-title">圧倒的な<br>耐久性能</h3>
            </div>
            <figure class="p-features__card-img">
              <img src="<?php echo get_template_directory_uri() ?>/images/about/feature_2.webp" alt="圧倒的な耐久性能" width="407" height="196">
            </figure>
          </div>
          <p class="p-features__card-text">高温焼成により粘土に含まれる長石が溶融し、<span>緻密な構造</span>が形成され、高い強度と耐久性を実現。<span>酸性雨</span>や<span>塩害</span>、<span>凍害</span>に非常に強い瓦です。</p>
        </div>
      </div>
    </div>
    </div>
