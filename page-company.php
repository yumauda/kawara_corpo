    ...
    <div class="p-maker__inner">
      <div class="p-maker__content">
        <figure class="p-maker__logo">
          <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/company/maker_logo.png" alt="" width="179" height="258">
        </figure>
        <div class="p-maker__detail">
          <h3 class="p-maker__title">当社は石州瓦業界最大の<br>
            生産量と販売規模を誇る<br>
            メーカーです。</h3>
          <p class="p-maker__text">瓦百景株式会社は、独特の美しさと高い耐久性を持ち、土と炎にこだわった「石州瓦」を守る挑戦を続けてまいります。<br>
            お客様からの厚いご支持をいただき、石州瓦の代表的なメーカーとして、お客様と共に歩む所存です。</p>


        </div>
        <figure class="p-maker__img">
          <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/company/maker_img.webp" alt="瓦建物の写真" width="560" height="516">
        </figure>
      </div>
    </div>
  </section>
