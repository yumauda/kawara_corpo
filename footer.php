        ...
        <div class="p-footer__content">
            <div class="p-footer__logo">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="p-footer__home">
                    <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/common/footer_logo.png" alt="瓦百景・採用サイト" width="366" height="206">
                </a>
            </div>
            <div class="p-footer__nav">
                ...
                <ul class="p-footer__lists">
                    ...
                    <li class="p-footer__list">
                        <a href="<?php echo esc_url(home_url('/privacy')); ?>" class="p-footer__link">プライバシーポリシー</a>
                    </li>
                </ul>
            </div>
            <div class="p-footer__recruit-wrapper">
